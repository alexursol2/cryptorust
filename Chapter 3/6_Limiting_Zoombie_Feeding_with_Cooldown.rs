...
{
    // simple function by removing the #[endpoint] annotation so that the contract is more secure
    fn feed_and_multiply(&self, zombie_id: usize, target_dna: u64, species: ManagedBuffer) {
        ...
        require!(self.is_ready(zombie_id), "Zombie is not ready"); // new require
        ...
        self.trigger_cooldown(zombie_id); // feeding triggers the zombie's cooldown time
    }
